...
class CourseController {
    ...
    */
    ...
    async getAssessmentForGrading({
        topicId
    }: GetAssessmentForGradingOptions): Promise<CourseWWTopicQuestion[]> {
